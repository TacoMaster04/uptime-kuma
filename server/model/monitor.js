...
class Monitor extends BeanModel {
    ...
    async start(io) {
        ...
        const beat = async () => {
            ...
            // See https://github.com/TacoMaster04/uptime-kuma/pull/3961#issuecomment-1804149144
        ...
        const safeBeat = async () => {
            try {
                ...
                log.error("monitor", "Please report to https://github.com/TacoMaster04/uptime-kuma/issues");
